...
<!--    </div>-->
<!--</section>-->
<section class="buttons_area">
    <div class="container">
        <div class="row">
            <div class="buttons">
                <a href="exp_create.php" class="blue-btn">Add Expens</a>
                <a href="exp_list.php" class="blue-btn">expens list</a>
            </div>

        </div>
        <div class="row">
            <div class="button">
                <a href="report.php" class="red-btn">report</a>
